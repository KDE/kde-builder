...
def test_ossupport():
    ...
    assert opts["ID"] == "kdesrc-build", "Right ID"
    ...
    assert os.bestDistroMatch(["arch", "kdesrc-build", "sabayon"]) == "kdesrc-build", "ID preferred"
    ...
    assert os.vendorID() == "kdesrc-build", "Right ID"
