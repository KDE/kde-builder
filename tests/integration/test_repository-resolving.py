...
def test_repository_resolution():
    ...
    assert module_list[0].get_option("#resolved-repository") == "kde:test/kcalc.git", "First party project, and explicitly using \"kde-projects\" magic value"
    assert module_list[1].get_option("#resolved-repository") == "kde:test/juk.git", "First party project, and implicitly using \"kde-projects\" magic value"
