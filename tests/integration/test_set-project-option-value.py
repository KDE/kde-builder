...
def test_set_project_option():
    ...
    """
    app = Application("--pretend --rc-file tests/integration/fixtures/sample-rc/kde-builder.yaml --set-project-option-value module2,tag,fake-tag10 --set-project-option-value setmod2,tag,tag-setmod10".split(" "))
